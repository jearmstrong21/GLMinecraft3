...
namespace client {
    ...
    struct rendered_chunk {
        ...
        void take_chunk(block::world *world, const std::shared_ptr<block::chunk> &chunk, int section = -1);
    ...
    private:
        void take_chunk_section(block::world *world, const std::shared_ptr<block::chunk> &chunk, int section);

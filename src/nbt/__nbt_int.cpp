...
namespace nbt {
    ...
    std::map<std::string,nbt_ptr> nbt_int::as_compound() const {
    ...
    std::vector<nbt_ptr> nbt_int::as_list() const {
    ...
    std::map<std::string, nbt_ptr> &nbt_int::compound_ref() {
    ...
    std::vector<nbt_ptr> &nbt_int::list_ref() {

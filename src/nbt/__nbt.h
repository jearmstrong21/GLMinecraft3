...
namespace nbt {
    ...
    typedef std::shared_ptr<nbt> nbt_ptr;
    ...
    struct nbt {
        ...
        [[nodiscard]] virtual std::map<std::string, nbt_ptr> as_compound() const = 0;

        [[nodiscard]] virtual float as_float() const = 0;

        [[nodiscard]] virtual int as_int() const = 0;

        [[nodiscard]] virtual std::vector<nbt_ptr> as_list() const = 0;
        ...
        [[nodiscard]] virtual std::map<std::string, nbt_ptr> &compound_ref() = 0;

        [[nodiscard]] virtual float &float_ref() = 0;

        [[nodiscard]] virtual int &int_ref() = 0;

        [[nodiscard]] virtual std::vector<nbt_ptr> &list_ref() = 0;

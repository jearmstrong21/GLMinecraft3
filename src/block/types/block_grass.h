...
namespace block {
    ...
    struct block_grass : block {
        ...
        const client::quad_texture_descr top{{client::atlas_texture::GRASS_TOP, glm::vec3(0.47, 0.82, 0.37)},
                                             {client::atlas_texture::NONE,      glm::vec3(1, 1, 1)}};
        const client::quad_texture_descr side{{client::atlas_texture::GRASS_SIDE,         glm::vec3(1, 1, 1)},
                                              {client::atlas_texture::GRASS_SIDE_OVERLAY, glm::vec3(0.47, 0.82, 0.37)}};
        const client::quad_texture_descr bot{{client::atlas_texture::DIRT, glm::vec3(1, 1, 1)},
                                             {client::atlas_texture::NONE, glm::vec3(1, 1, 1)}};
